      ...
      <div className="about-grid">
        ...
        >
          <p className="about-text">
            I’m <strong>Vishal Junghare</strong>, a software engineer with <strong>3+ years of experience</strong>
            across backend development, cloud security, automation, and modern application delivery.
            My core strength is building scalable services with <strong>Java</strong>, <strong>Spring Boot</strong>, and
            <strong> AWS</strong>, while also contributing to frontend experiences using <strong>React</strong> when the product needs it.
          </p>

          <p className="about-text">
            A lot of my recent work has focused on <strong>governance</strong>, <strong>security automation</strong>,
            <strong> policy-driven engineering</strong>, and <strong>production-grade workflows</strong> — the kind of work where performance,
            clarity, and reliability matter just as much as writing code that works.
          </p>

          <p className="about-text">
            What excites me most is solving engineering problems that sit between systems and product experience:
            reducing repetitive manual work, improving validation flows, tightening integrations, and making technical
            decisions that feel thoughtful to both users and teams.
          </p>
        </motion.div>

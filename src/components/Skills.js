...
const Skills = () => {
    ...
    return (
        <section className="skills-section section-card" id="skills">
            ...
            <div className="skills-tab-row" role="tablist" aria-label="Skill categories">
                {skillCategories.map((category) => {
                    ...
                    return (
                        ...
                        >
                            <span className={`skills-tab-icon ${category.colorClass}`}>{category.icon}</span>
          ...
          <span className={`skills-summary-icon ${activeCategory.colorClass}`}>
            {activeCategory.icon}
          </span>
                    ...
                    {activeCategory.skills.map((skill) => (
                        <article className="skill-card" key={skill.title}>
                            <div className="skill-card-title-row">
                                <span className={`skill-card-icon ${skill.colorClass}`}>{skill.icon}</span>
                                <h4>{skill.title}</h4>
                            </div>
